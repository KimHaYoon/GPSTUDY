...
bool CRasterizerState::CreateRasterizerState(const string & strKey, D3D11_FILL_MODE eFill, D3D11_CULL_MODE eCull, bool bClockWise, int iDepthBias, float fDepthBiasClamp, float fSlopeScale, bool bDepthClipEnable, bool bScissorEnable, bool bMultisampleEnable, bool bAntialisedLineEnable)
{
	m_strKey = strKey;
